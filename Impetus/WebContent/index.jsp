    ...
    <body>
       ...
       <!--navbar-->
        ...
        <div class="container-fluid p-0 m-0">
            ...
            <div style="background:#00796b!important"class="jumbotron  text-white banner-background">
                <div class="container">
                    <h3 class="display-3">Welcome to Impetus </h3>
					
                    <p>Welcome to Impetus where you will be updated with latest programming trends and we also provide training and placement.                  
                        Over this blog you can share your knowledge and also read articles posted by fellow developers.
                    </p>
                ...
                <div class="col-md-4">
                    <div class="card" >
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Python is an interpreted, high-level and general-purpose programming language. Created by Guido van Rossum and first released in 1991, Python's design philosophy emphasizes code readability with its notable use of significant whitespace.</p>
                            <a href="#" class="btn primary-background text-white">Read more</a>
                        </div>
                    </div>
                </div>
